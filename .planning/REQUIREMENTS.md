# Requirements: Antler Room Website
...
- **BACK-01**: Form submission to email or database
- **BACK-02**: Submission confirmation email to artist
- **BACK-03**: Admin notification for new submissions

### Enhancements

- **ENH-01**: Animated section transitions on scroll
- **ENH-02**: Parallax effects for visual depth
- **ENH-03**: Artist portfolio/success stories section
- **ENH-04**: Embedded music player samples

## Out of Scope

| Feature | Reason |
|---------|--------|
| CMS integration | Static site, content changes infrequent |
| Blog/news section | Not in brief, adds complexity |
| Artist login/dashboard | Public-facing site only |
| E-commerce/payments | Not a store |
| Multi-language support | English only in brief |
